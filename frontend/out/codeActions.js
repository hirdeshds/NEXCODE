...
exports.NexCodeActionProvider = void 0;
const vscode = __importStar(require("vscode"));
class NexCodeActionProvider {
    provideCodeActions() {
        const explainAction = new vscode.CodeAction("NexCode: Explain Code", vscode.CodeActionKind.QuickFix);
